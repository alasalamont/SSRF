...
def main():
    ...
    print("")
    print("")
    print(f"{Style.BRIGHT}{Fore.BLUE}OPTION-4: gopher-post-basic: The data-sent is in {Fore.RED}www-form-urlencoded{Style.RESET_ALL}{Style.BRIGHT}{Fore.BLUE} format")
